 ...
 */
class Version20260115162909 extends AbstractMigration
{
    /**
    ...
    protected array $files = [
        'PimPrint_CarsDemo_Template_pimcore.indd',
        'PimPrint_CarsDemo_Template_mds.indd',
        'PimPrint_CarsDemo_Template_inter.indd',
        'PimPrint_Cars_SalesLabel_pimcore.indd',
        'PimPrint_Cars_SalesLabel_mds.indd',
        'PimPrint_Cars_SalesLabel_inter.indd',
    ];
     ...
     * @throws \Exception
     */
    private function importAssets(array $files, Folder $folder): void
    {
    ...
    {
        return __DIR__ . DIRECTORY_SEPARATOR . $this->path . DIRECTORY_SEPARATOR . $file;
    }
